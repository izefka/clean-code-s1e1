...
var completedTasksHolder=document.getElementById("item_completed-tasks");//item_completed-tasks
...
var addTask=function(){
    ...
    //Create a new list item with the text from the #add-task__title:
...
var taskCompleted=function(){
    ...
    //Append the task list item to the #item_completed-tasks
    var listItem=this.parentNode;
